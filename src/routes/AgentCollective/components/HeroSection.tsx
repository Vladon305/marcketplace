      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center space-y-8 animate-fade-in">
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-gray-600">
            Connect with top AI developers and find the perfect automation
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            ...
            <button className="inline-flex items-center px-6 py-3 rounded-lg border text-black border-gray-200 hover:border-gray-300 transition-colors">
              For Developers
            </button>
          </div>
        </div>
